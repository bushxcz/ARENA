    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8" style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.15em', color: 'rgba(232,232,224,0.7)' }}>
          ...
          <a href="#testimonials" className="hover:text-[#00FF88] transition-colors">Testimonials</a>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-white/5 mt-4 px-6 py-6 flex flex-col gap-4" style={{ background: 'rgba(4,6,8,0.95)', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.15em' }}>
          <a href="#features" className="text-[#E8E8E0]/70 hover:text-[#00FF88] transition-colors" onClick={() => setMobileOpen(false)}>Features</a>
          <a href="#stats" className="text-[#E8E8E0]/70 hover:text-[#00FF88] transition-colors" onClick={() => setMobileOpen(false)}>Stats</a>
          <a href="#testimonials" className="text-[#E8E8E0]/70 hover:text-[#00FF88] transition-colors" onClick={() => setMobileOpen(false)}>Testimonials</a>
          <a href="#pricing" className="text-[#E8E8E0]/70 hover:text-[#00FF88] transition-colors" onClick={() => setMobileOpen(false)}>Pricing</a>
          <a href="/auth/signup" className="axon-btn mt-2" style={{ padding: '0.5rem 1.25rem', fontSize: '0.7rem' }}>Join Now</a>
        </div>
      )}
    </nav>
  )
